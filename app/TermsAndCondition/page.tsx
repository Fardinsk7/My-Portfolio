...
const TermAndCondition = () => {
  return (
    <div className="m-12">
      <h1 className="text-3xl underline font-bold">Terms and Conditions</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Fardinsk.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Fardinsk, accessible from{" "}
            <a
              href="https://www.fardinsk.xyz/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.fardinsk.xyz/
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="text-2xl underline font-bold">Acknowledgment</h2>
      <p>
      ...
      <h2 className="text-2xl underline font-bold">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="text-2xl underline font-bold">Termination</h2>
      <p>
      ...
      <h2 className="text-2xl underline font-bold">Limitation of Liability</h2>
      <p>
      ...
      <h2 className="text-2xl underline font-bold">Governing Law</h2>
      <p>
      ...
      <h2 className="text-2xl underline font-bold">Disputes Resolution</h2>
      <p>
      ...
      <h2 className="text-2xl underline font-bold">Severability and Waiver</h2>
      ...
      <h2 className="text-2xl underline font-bold">Contact Us</h2>
      <p>
